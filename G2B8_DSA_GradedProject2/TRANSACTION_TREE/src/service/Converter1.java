...
/**
 * Converter1 is a class that converts a Binary Search Tree (BST) to a Right Skewed Binary Search Tree (BST).
 */
public class Converter1 {
    ...
    /**
     * Constructor for Converter1.
     * Initializes the root node with a value of -1.
